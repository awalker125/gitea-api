...
```sh
pip install git+https://github.com/awalker125/gitea-api.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/awalker125/gitea-api.git`)
